...
// const likeButton = {
//     initFields() {
//             document.getElementsById('content').addEventListener('submit', (e) => {
//             e.preventDefault();
//             const liked = document.getElementsById('likes').value;
//             console.log(liked);
//             this.postData(liked);
//         })
//     }
...
async function postData(url = '', data = {"UUID": [1]}) {
    const response = await fetch(url, {
            method: 'POST',
            headers: {
